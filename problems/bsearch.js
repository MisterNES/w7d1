...
//console.log(iterBSearch([1, 2, 3], 4));
...
const recurBSearchIdx = (nums, targetNum) => {
  ...
  if (targetNum < ele) {
    recurBSearchIdx(left, targetNum);
  } else if (targetNum > ele) {
    recurBSearchIdx(right, targetNum);
  } else {
